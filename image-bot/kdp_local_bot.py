...
def _chroma_key(img_bgra, dominant_bgr):
    ...
    edge_and_bg = edge_zone & (delta_e < 38)
    fade_mask = edge_zone & (delta_e >= 28) & (delta_e < 38)
    a_float = a_c.astype(np.float32)
    a_float[edge_and_bg & (delta_e < 28)] = 0
    fade_factor = (delta_e[fade_mask] - 28) / (38 - 28)
